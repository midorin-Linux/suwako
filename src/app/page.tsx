        ...
        <>
            ...
            <main className={`relative z-0`}>
                ...
                <section className={`bg-[#5a5359]`}>
                    <article className={`relative mx-auto flex w-full max-w-7xl min-h-120 flex-col justify-between overflow-hidden pl-4 pt-8 sm:min-h-140 sm:pl-8 sm:pt-10 lg:min-h-0 lg:flex-row lg:items-center lg:gap-10 lg:pl-12`}>
